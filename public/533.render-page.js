...
function m(e,n){let t;return (...o)=>{let r=()=>e(...o);t&&clearTimeout(t),t=setTimeout(r,n&&n>0?n:300);}}function L(e,n){return new Promise((t,o)=>{if(document.getElementById(e)){t("CSS already loaded.");return}let r=document.createElement("link");r.id=e,r.setAttribute("rel","stylesheet"),r.setAttribute("href",n),r.addEventListener("load",()=>t("CSS loaded.")),r.addEventListener("error",()=>o("Error loading css.")),r.addEventListener("abort",()=>o("CSS loading aborted.")),document.head.appendChild(r);})}var F=e=>{e?.key==="Tab"&&(e.preventDefault(),document.execCommand("insertHTML",!1,"&#009"));};
